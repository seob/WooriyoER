...
open class AwesomeTextField: UITextField {
  ...
  private func setupObserver() { 
    ...
    NotificationCenter.default.addObserver(forName: UITextField.textDidBeginEditingNotification, object: self, queue: OperationQueue.main) { (notification) in
        self.didBeginChangeText()
    }
    
    NotificationCenter.default.addObserver(forName: UITextField.textDidChangeNotification, object: self, queue: OperationQueue.main) { (notification) in
        self.didChangeText()
    }
    
    NotificationCenter.default.addObserver(forName: UITextField.textDidEndEditingNotification, object: self, queue: OperationQueue.main) { (notification) in
        self.didEndChangingText()
    }
  }
