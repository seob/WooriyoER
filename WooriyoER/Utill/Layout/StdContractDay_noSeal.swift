...
class StdContractDay_noSeal: ExampleFactory {
    ...
    func generateDocument() -> [PDFDocument] {
        ...
        section.columns[0].set(font: UIFont(name: "NotoSansCJKkr-DemiLight", size: 10.0) ?? UIFont.systemFont(ofSize: 10.0))
