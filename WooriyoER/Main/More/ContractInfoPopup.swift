...
class ContractInfoPopup: UIViewController , PanModalPresentable {
    ...
    private func setupView() {
        ...
        self.configure(with: SelLcEmpInfo, SelLcEmpInfo.viewpage)
