...
class Lc_empListVC: UIViewController {
    ...
    var empTuple : [LcEmpList] = []
    var fillterData : [LcEmpList] = []
    ...
    override func viewDidLoad() {
        ...
        tblList.register(UINib.init(nibName: "LcEmpListCell", bundle: nil), forCellReuseIdentifier: "LcEmpListCell")
...
//        btnNotWork.setImage(UIImage(named: "btn_tab_normal"), for: .normal)
    ...
    fileprivate func updatePopup(_ nm: String , _ pn: String , _ email: String){
        let vc = ContractSB.instantiateViewController(withIdentifier: "StartContractPopUp") as! StartContractPopUp
        vc.modalTransitionStyle = .crossDissolve
        vc.modalPresentationStyle = .overFullScreen
    ...
    func getTotalList() {
        NetworkManager.shared().getLc_empList(cmpsid: cmpsid) { (isSuccess, resData) in
            if(isSuccess){
...
extension Lc_empListVC: UITableViewDelegate , UITableViewDataSource  {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = tableView.dequeueReusableCell(withIdentifier: "LcEmpListCell", for: indexPath) as? LcEmpListCell {
            var empListIndexPath: LcEmpList = LcEmpList()
            if self.searchText != "" {
...
extension Lc_empListVC: UITextFieldDelegate {
