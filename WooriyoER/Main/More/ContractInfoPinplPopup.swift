//
//  ContractInfoPinplPopup.swift
//  PinPle
//
//  Created by seob on 2020/07/01.
//  Copyright © 2020 WRY_010. All rights reserved.
//

import UIKit

class ContractInfoPinplPopup: UIViewController , PanModalPresentable {
...
//    }()
    ...
    override func viewDidLoad() {
        ...
        print("\n---------- [ 1 ContractInfoPinplPopup : \(SelPinplLcEmpInfo.toJSON()) ] ----------\n")
    ...
    fileprivate func tempSave(){
        ...
        case "step6" :
            ...
            selInfo.phonenum = selInfo.phonenum == "" ? "" : selInfo.phonenum
...
extension ContractInfoPinplPopup  {
