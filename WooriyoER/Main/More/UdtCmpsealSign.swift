...
extension UdtCmpsealSign: SwiftyDrawViewDelegate {
...
class UdtCmpsealSign: UIViewController , UIScrollViewDelegate{
...
extension UdtCmpsealSign: UITextFieldDelegate {
