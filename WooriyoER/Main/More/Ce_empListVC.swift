...
class Ce_empListVC: UIViewController {
...
//        btnNotWork.setImage(UIImage(named: "btn_tab_normal"), for: .normal)
    ...
    func getTotalList() {
        NetworkManager.shared().getCe_empList(cmpsid: cmpsid) { (isSuccess, resData) in
            if(isSuccess){
...
extension Ce_empListVC: UITableViewDelegate , UITableViewDataSource  {
...
extension Ce_empListVC: UITextFieldDelegate {
