...
class Ce_CertifiCrop: UIViewController , UIScrollViewDelegate, NVActivityIndicatorViewable{
    
    
    var initialImage: UIImage?
    var delegate: Certi_ProfileViewControllerProtocol?
